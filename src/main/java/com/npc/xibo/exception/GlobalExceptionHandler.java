...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResultResponse> handleMissingServletRequestParameterException(
    ...
    public ResponseEntity<ResultResponse> handleHttpRequestMethodNotSupportedException(
    ...
    public ResponseEntity<ResultResponse> handleHttpMediaTypeNotSupportedException(
